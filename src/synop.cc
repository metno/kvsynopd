 ...
 *
 * Alts�, det er E' som bestemmer om SA=-1 er flekkvis sn�. I koding av synop
 * m� en alts� for alle typeid bruke kombinasjonen av SA og E' eller SA og SD 
 * for � kunne angi 998 i synop.
 ...
 * N�r det skal lages synop fra kvalobs s� m� det kanskje ut fra dette til en 
 * justering av dagens enkoder slik at koding av SA og EM blir riktig? (For 302
 * m� kun SA benyttes i synop - ikke SD.) 
 * 
 */
 ...
 * Nedb�ren beregnes ved � ta differansen mellom  RA fra synoptidspunktet og
 * RA 12 (evt 24) timer tilbake. Dette betyr at nedb�ren bergnes p� f�lgende
 * m�te for synoptidspunktene 06, 12, 18 og 24. Bruke notasjonen RA(t) for �
 * angi b�tteinholdet ved timen t. Eks RA(12) er b�tteinnholdet kl 12.
 * 
 * synoptidspunkt kl 00 og 12,  6 timers nedb�r:
 *    nedb�r= RA(t)-RA(t-6)
 *
 * synoptidspunkt kl 6 og 18,  12 timers nedb�r:
 *    nedb�r=RA(t)-RA(t-12)
 *
...
/*
 * synoptidspunkt kl 00 og 12,  6 timers nedb�r: RR_6
 * synoptidspunkt kl 6 og 18,  12 timers nedb�r: RR_12
 * 
 ...
 * Nedb�ren beregnes ved � summere RR fra synoptidspunktet og
...
/*
** Funksjonen splittar strengen ved karakter nr. index (ved n�raste space),
